...
namespace Utilities.Mathematics.Statistics.Distributions
{
	...
	public class GenzMultivariateClosed
	{
		...
		static double pntgnd(double ba, double bb, double bc, double ra, double rb, double r, double rr)
		{
		...
		static double Tvtmfn(double x, double l1, double l2, double l3, double correl21, double correl31, double correl32)
		{
		...
		static void Kronrod(double lower, double upper, double l1, double l2, double l3, double correl21, double correl31, double correl32, double[] WG, double[] WGK, double[] XGK, out double Kronrodint, out double Kronroderr)
		{
