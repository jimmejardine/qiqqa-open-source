...
namespace Utilities.Mathematics.Optimisation.NelderMead
{
    ...
    {
        private const double GROW_FACTOR = 2.0;
        private const double REFLECT_FACTOR = -1.0;
        private const double CONTRACT_FACTOR = 0.5;
        private const double SHRINK_FACTOR = 0.5;

        public double MAX_ITERATIONS = 10000;
        public double TOLERANCE = 1E-12;
        private ObjectiveFunction2D objective_function;
        ...
        private bool testOnePointMove(double scale, ref Point2D mid_point)
        {
            Point2D new_point;
