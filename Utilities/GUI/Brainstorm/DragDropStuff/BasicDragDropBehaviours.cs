...
namespace Utilities.GUI.Brainstorm.DragDropStuff
{
    /// <summary>
    ...
    class BasicDragDropBehaviours
    {
        ...
        internal void RegisterBehaviour(Type type, DragDropManager.DragDropTypeHandler handler)
        {
            drag_drop_manager.RegisterDropType(type, handler);
        }
        
        internal void RegisterBehaviours()
        {
            //RegisterBehaviour(typeof(PDFDocument), OnDrop_PDFDocument);
            //RegisterBehaviour(typeof(List<PDFDocument>), OnDrop_PDFDocumentList);
            //RegisterBehaviour(typeof(PDFAnnotation), OnDrop_PDFAnnotation);
        }
