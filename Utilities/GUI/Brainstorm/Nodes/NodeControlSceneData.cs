...
namespace Utilities.GUI.Brainstorm.Nodes
{
    ...
    public class NodeControlSceneData
    {
        ...
        double current_scale_at_last_resize; // *** NB: Do not remove this or serialization will break
        ...
        public double Left { get { return CentreX - Width; } }
        public double Top { get { return CentreY - Height; } }
    }
}
