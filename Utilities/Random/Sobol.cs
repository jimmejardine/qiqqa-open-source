...
namespace Utilities.Random
{
	public class Sobol : IUniformRandomSource
	{
		...
		int dim;			// Number of dimensions generated by this instance
		ulong [,] directions;		// directions[k] - array of direction numbers for dimension k
		int[,] coefficients;			// coefficients[k] - coefficient array of the k-th primitive polynomial
		int[] degrees;			// degrees[k] - degree of the k-th primitive polynomial
		ulong[] x_integer;		// current vector of Sobol integers
		double[] x_real;	// current vector of Sobol reals
