# [Stuff To Look At](../Links%20to%20Stuff%20To%20Look%20At.md): Metadata Search Engines
...
A small FLASK web service, taking a filename from the POST request, loads the corresponding file from the LIBINTEL\_:UPLOAD_DIR directory containing an unformatted list of references.
