...
1. add mutool commands' options to have these errors reported or silently ignored -- in the latter case we'll have to doublecheck our generated PostScript and probably track the produced ( braces in certain parts of fmt/print...
