...
***huh?*** "**cannot fwrite: No space left on device**"? There's still *299GB* space left on the output/scratch HDD and none of the other HDDs is full either. What is going on here?
