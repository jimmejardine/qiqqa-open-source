...
namespace Qiqqa.Brainstorm.Nodes
{
    public class NodeContentControlRegistry
    {
        ...
        private void RegisterNodeContentControls()
        {
            ...
            RegisterNodeContentControl(typeof(PDFDocumentNodeContent), typeof(PDFDocumentNodeContentControl));
            RegisterNodeContentControl(typeof(PDFAnnotationNodeContent), typeof(PDFAnnotationNodeContentControl));
            RegisterNodeContentControl(typeof(PDFAuthorNodeContent), typeof(PDFAuthorNodeContentControl));
            RegisterNodeContentControl(typeof(PDFTagNodeContent), typeof(PDFTagNodeContentControl));
            RegisterNodeContentControl(typeof(PDFAutoTagNodeContent), typeof(PDFAutoTagNodeContentControl));
            RegisterNodeContentControl(typeof(EllipseNodeContent), typeof(EllipseNodeContentControl));
            RegisterNodeContentControl(typeof(ThemeNodeContent), typeof(ThemeNodeContentControl));
            RegisterNodeContentControl(typeof(LibraryNodeContent), typeof(LibraryNodeContentControl));
        }

        private void RegisterNodeEditorControls()
        {
            RegisterNodeContentEditor(typeof(StringNodeContent), typeof(StringNodeContentEditor));
            RegisterNodeContentEditor(typeof(PDFAuthorNodeContent), typeof(PDFAuthorNodeContentEditor));
            RegisterNodeContentEditor(typeof(PDFTagNodeContent), typeof(PDFTagNodeContentEditor));
            RegisterNodeContentEditor(typeof(PDFAutoTagNodeContent), typeof(PDFAutoTagNodeContentEditor));
            RegisterNodeContentEditor(typeof(PDFDocumentNodeContent), typeof(PDFDocumentNodeEditorControl));
            RegisterNodeContentEditor(typeof(PDFAnnotationNodeContent), typeof(PDFAnnotationNodeEditorControl));
            RegisterNodeContentEditor(typeof(ThemeNodeContent), typeof(ThemeNodeContentEditor));
        }
    }
}
