...
namespace QiqqaUnitTester
{
    ...
    public class AsyncFireAndForget
    {
        ...
        public string ExampleFireAndForgetFunc(Func<bool> exec = null, CancellationTokenSource cts = null)
        {
            cts = cts ?? new CancellationTokenSource();
            MyAsyncMethod(exec, cts)
        ...
        public async Task MyAsyncMethod(Func<bool> exec, CancellationTokenSource cts)
        {
