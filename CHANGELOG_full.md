...
# v83pre release: v83.0.7656-36858 (UNPUBLISHED)
...
* (e9d06c27) updated CHANGELOG_full.md
...
* (71c15b2d) Merge remote-tracking branch 'remotes/jimmejardine-original/master'
...
* (7c662209) synced CHANGELOG.md and CHANGELOG_full.md
...
* (39cfa87b) Merge remote-tracking branch 'remotes/jimmejardine-original/master'
...
* (3050e4a0) Update README.md
			
* (e6bce21f) Update README.md
			
* (f96bc0b4) Update README.md
			
* (8987d850) Update README.md
			
* (71a0344b) Update README.md
			
* (540a0e2d) Update README.md
...
* (50a3db26) Merge branch 'mupdf-et-al'
  
  # Conflicts:
  #	Qiqqa.Build/Packaging/Content/license.txt
			
* (0438ee68) update submodules
			
* (0bc6d6da) updated CHANGELOG
...
* (b0aa5643) bump version and update CHANGELOG
...
* (8737580e) Merge remote-tracking branch 'remotes/GerHobbelt/master'
			
* (fd2ae14e) Merge remote-tracking branch 'remotes/jimmejardine-original/master' into mupdf-et-al
...
* (5afb9ed3) augmented the BibTeX tex escapes vs. Unicode conversion code tests a bit as a round-trip conversion, i.e. TeX->Unicode->TeX MAY NOT produce the exact same string as final result, when compared with the original input string. Hence a simple assert.equal() won't do any more.
...
* (b1f05191) Update CHANGELOG_full.md
			
* (7a7d7480) Update CHANGELOG.md
...
* (2ea706f1) updated CHANGELOGs
			
* (0c67136e) updated version
...
* (63bab7af) reemove superfluous check&set: the variablee has already been set when the condition is true
...
* (df2a99c6) updated xml file (version)
			
* (197281b3) update CHANGELOG.md et al
			
* (fe5972a5) created a new release.
...
* (f1ec34b4) Update Installing Qiqqa - Updating Qiqqa.md
			
* (58bb1c0c) Update Installing Qiqqa - Updating Qiqqa.md
			
* (3467a72d) Update Installing Qiqqa - Updating Qiqqa.md
			
* (c64b1ac9) Update Installing Qiqqa - Updating Qiqqa.md
			
* (09eb0ff5) It's late. Forgot to save the MD file. :-(
  writing the qiqqa download + install procedure for users as per https://github.com/jimmejardine/qiqqa-open-source/issues/228 request. HTH.
			
* (e2148680) writing the qiqqa download + install procedure for users as per https://github.com/jimmejardine/qiqqa-open-source/issues/228 request. HTH.
...
* (00b6121d) Merge remote-tracking branch 'remotes/jimmejardine-original/master' into documentation
			
* (8b22dddd) Update Qiqqa Sniffer - or how to access Google Scholar et al.md
			
* (f21d80fb) Update Qiqqa Sniffer - or how to access Google Scholar et al.md
...
* (794bcab8) Merge remote-tracking branch 'remotes/jimmejardine-original/master' into mainline-master
