                ...
                try
                {
                    ...
                    if (include_additional_fields)
                    {
                        ...
                        if (pdf_document_export_items.ContainsKey(pdf_document.Fingerprint))
                        {
                            ...
                            bibtex.SetIfHasValue("filename", bibtex_filename);
                            bibtex.SetIfHasValue("file", bibtex_file);
                        }
                        else
                        {
                        ...
                        // Fill in the tags and autotags
                        {
                            ...
                            {
                                bibtex.SetIfHasValue("Tags", tags);
                            }
                            ...
                            {
                                bibtex.SetIfHasValue("AutoTags", autotags);
                            }

                            string keywords = bibtex["keywords"];
                            if (!String.IsNullOrEmpty(tags))
                            {
                            ...
                            {
                                bibtex.SetIfHasValue("keywords", keywords);
                            }
                        }
                    }
