...
!(function (t) {
  function e(e) {
    for (
      var r, a, s = e[0], l = e[1], c = e[2], f = 0, p = [];
      f < s.length;
      f++
    )
      (a = s[f]),
  ...
  function (t, e) {
    ...
    t.exports = function (t, e, n) {
      ...
      function b(t) {
        return (c = t), (s = setTimeout(w, e)), u ? y(t) : a;
      }
      function _(t) {
        var n = t - l;
        return void 0 === l || n >= e || n < 0 || (m && t - c >= i);
      }
      function w() {
        var t = d();
        if (_(t)) return x(t);
      ...
      function C() {
        ...
        if (((r = arguments), (o = this), (l = t), n)) {
          ...
          if (m) return (s = setTimeout(w, e)), y(l);
        }
        ...
        typeof (r = function () {
          ...
          (n.configure = function (t) {
            ...
            (n.set = function (t) {
              ...
              var l = n.render(!e),
                c = l.querySelector(r.barSelector),
                u = r.speed,
                f = r.easing;
              return (
                l.offsetWidth,
          ...
          function h(n, r, a) {
            ...
            n === e.body
              ? ((l = t),
                ...
                (f = o.scroll))
              : ((l = n), (c = n.scrollLeft), (u = n.scrollTop), (f = s)),
              d({
                scrollable: l,
                method: f,
                startTime: p,
  ...
  function (t, e, n) {},
  function (t, e, n) {
    Promise.all([n.e(0), n.e(19)]).then(n.t.bind(null, 13, 7));
  },
  function (t, e, n) {},
  function (t, e, n) {
    "use strict";
  ...
  function (t, e, n) {
      ...
      if (!a || !1 !== a.configurable) {
        ...
        Object.defineProperty(t, e, {
          ...
          get: function () {
            ...
            return (
              ut.target &&
                (i.depend(), c && (c.dep.depend(), Array.isArray(e) && St(e))),
              e
            );
          },
          set: function (e) {
            ...
            e === r ||
              (e != e && r != r) ||
              (s && !l) ||
              (l ? l.call(t, e) : (n = e), (c = !o && qt(e)), i.notify());
          },
        });
      }
    }
    ...
    ($t.prototype.walk = function (t) {
      ...
      ($t.prototype.observeArray = function (t) {
        for (var e = 0, n = t.length; e < n; e++) qt(t[e]);
      });
        ...
        (function (t, e) {
          ...
          if (n) {
            ...
            if (Array.isArray(n))
              ...
              for (var a in n) (o = n[a]), (i[C(a)] = u(o) ? o : { type: o });
            else 0;
            t.props = i;
          }
        })(e),
    ...
    function ae(t, e, n, r, i, s) {
      ...
      for (l in t)
        (c = t[l]),
          ...
          o(c) ||
            (o(u)
              ? (o(c.fns) && (c = t[l] = ie(c, s)),
                a(f.once) && (c = t[l] = i(f.name, c, f.capture)),
              ...
              o((l = e[r])) ||
                ...
                Array.isArray(l)
                  ? l.length > 0 &&
                    (ue((l = t(l, (n || "") + "_" + r))[0]) &&
                      ue(u) &&
                      ((f[c] = gt(u.text + l[0].text)), l.shift()),
                    f.push.apply(f, l))
                  : s(l)
                  ? ue(u)
                    ? (f[c] = gt(u.text + l))
    ...
    function Pe(t, e, n, o, i) {
      ...
      (this.data = t),
        ...
        (this.slots = function () {
          return l.$slots || he(t.scopedSlots, (l.$slots = pe(n, o))), l.$slots;
        }),
              ...
              (t = (function (t, e) {
                ...
                if (n && !i(t.owners)) {
                  ...
                  var f = function (t) {
                    ...
                    p = R(function (n) {
                      (t.resolved = Fe(n, e)), s ? (r.length = 0) : f(!0);
                    }),
                    h = R(function (e) {
                    ...
                    l(v) &&
                      (d(v)
                        ...
                        : d(v.component) &&
                          ...
                          i(v.error) && (t.errorComp = Fe(v.error, e)),
                          i(v.loading) &&
                            ((t.loadingComp = Fe(v.loading, e)),
                            0 === v.delay
                              ? (t.loading = !0)
          ...
          if (a(t.options.functional))
            return (function (t, e, n, o, a) {
              var s = t.options,
                l = {},
                c = s.props;
              if (i(c)) for (var u in c) l[u] = Mt(u, c, e || r);
              else i(n.attrs) && Le(l, n.attrs), i(n.props) && Le(l, n.props);
    ...
    function ze(t, e, n) {
      (Be = t), ae(e, n || {}, He, We, Xe, t), (Be = void 0);
    }
    var Ge = null;
    function Ke(t) {
      var e = Ge;
      ...
      (t.data.directives || e.data.directives) &&
        (function (t, e) {
          var n,
            ...
            l = ar(e.data.directives, e.context),
            c = [],
            u = [];
          for (n in l)
            (r = s[n]),
          ...
          if (!i) for (n in s) l[n] || lr(s[n], "unbind", t, t, a);
        })(t, e);
    }
    ...
    function ur(t, e) {
      ...
      if (
        ...
        var r,
          ...
          l = t.data.attrs || {},
          c = e.data.attrs || {};
        for (r in (i(c.__ob__) && (c = e.data.attrs = S({}, c)), c))
          (a = c[r]), l[r] !== a && fr(s, r, a);
        for (r in ((G || Y) && c.value !== l.value && fr(s, "value", c.value),
        l))
          o(c[r]) &&
            (Dn(r)
    ...
    function $r(t, e) {
      if (!o(t.data.domProps) || !o(e.data.domProps)) {
        var n,
          ...
          s = t.data.domProps || {},
          l = e.data.domProps || {};
        for (n in (i(l.__ob__) && (l = e.data.domProps = S({}, l)), s))
          n in l || (a[n] = "");
        for (n in l) {
    ...
    function Rr(t, e) {
      ...
      if (!(o(n.staticStyle) && o(n.style) && o(r.staticStyle) && o(r.style))) {
        ...
        for (s in f) o(d[s]) && jr(l, s, "");
        for (s in d) (a = d[s]) !== f[s] && jr(l, s, null == a ? "" : a);
      }
    }
    ...
    function Nr(t) {
      if (t) {
        if ("object" == typeof t) {
          var e = {};
          return !1 !== t.css && S(e, Fr(t.name || "v")), S(e, t), e;
        }
    ...
    Qr &&
      (void 0 === window.ontransitionend &&
        ...
        ((Vr = "WebkitTransition"), (Hr = "webkitTransitionEnd")),
    ...
    function to(t, e) {
      ...
      return (
        "transition" === e
          ...
          : "animation" === e
          ? c > 0 && ((n = "animation"), (u = c), (f = l.length))
          : (f = (n =
              (u = Math.max(a, c)) > 0
                ? a > c
                  ? "transition"
              ...
              : 0),
        {
          ...
          timeout: u,
          propCount: f,
          hasTransform: "transition" === n && Jr.test(r[Vr + "Property"]),
        }
      );
    }
    function eo(t, e) {
    ...
    function ro(t, e) {
      ...
      if (!o(r) && !i(n._enterCb) && 1 === n.nodeType) {
        for (
          ...
          (q = k.context), (k = k.parent);
        var O = !q._isMounted || !t.isRootInsert;
        if (!O || w || "" === w) {
          var T = O && p ? p : c,
            S = O && h ? h : f,
            A = O && d ? d : u,
          ...
          var D = !1 !== a && !K,
            ...
            U = (n._enterCb = R(function () {
              D && (Yr(n, A), Yr(n, S)),
                U.cancelled ? (D && Yr(n, T), L && L(n)) : j && j(n),
                (n._enterCb = null);
            }));
          t.data.show ||
            ...
            D &&
              ...
              Gr(function () {
                Yr(n, T),
                  U.cancelled ||
                    (Kr(n, A), M || (io(I) ? setTimeout(U, I) : Zr(n, s, U)));
              })),
      ...
      if (!i(n._leaveCb)) {
        ...
        var x = (n._leaveCb = R(function () {
          n.parentNode &&
            ...
            b && (Yr(n, u), Yr(n, f)),
            x.cancelled ? (b && Yr(n, c), m && m(n)) : (e(), h && h(n)),
            (n._leaveCb = null);
        }));
        g ? g(C) : C();
      }
        ...
        x.cancelled ||
          ...
          b &&
            ...
            Gr(function () {
              Yr(n, c),
                x.cancelled ||
                  (Kr(n, u), _ || (io(w) ? setTimeout(x, w) : Zr(n, s, x)));
            })),
          d && d(n, x),
          b || _ || x());
      }
    ...
    var lo = (function (t) {
      ...
      for (e = 0; e < tr.length; ++e)
        for (r[tr[e]] = [], n = 0; n < l.length; ++n)
          i(l[n][tr[e]]) && r[tr[e]].push(l[n][tr[e]]);
      function u(t) {
      ...
      function g(t, n) {
        for (var o = 0; o < r.create.length; ++o) r.create[o](Jn, t);
        i((e = t.data.hook)) &&
          (i(e.create) && e.create(Jn, t), i(e.insert) && n.push(t));
      }
      function y(t) {
        var e;
                      ...
                      o(v)
                        ...
                        : (o(s) && (s = nr(e, p, h)),
                          o((l = i(y.key) ? s[y.key] : C(y, e, p, h)))
                            ...
                            ? ($(u, y, r, n, d),
                              (e[l] = void 0),
                              x && c.insertBefore(t, u.elm, v.elm))
                            : f(y, r, t, v.elm, !1, n, d),
                          (y = n[++d]));
                    p > h
            ...
            i.key =
              null == i.key
                ...
                ? 0 === String(i.key).indexOf(a)
                  ...
                  : a + i.key
                : i.key;
            var l = ((i.data || (i.data = {})).transition = xo(this)),
              c = this._vnode,
              u = wo(c);
            if (
              (i.data.directives &&
                i.data.directives.some(qo) &&
                (i.data.show = !0),
              u &&
                u.data &&
                !(function (t, e) {
    ...
    (Cn.config.mustUseProp = function (t, e, n) {
      ...
      S(Cn.options.directives, bo),
      S(Cn.options.components, Eo),
      (Cn.prototype.__patch__ = H ? lo : E),
    ...
    var Ro = {
      ...
      render: function (t, e) {
        ...
        return (
          g && (Io(c[s], { route: l, configProps: g }), Do(m, i, l, g)),
          a(m, i, r)
        );
      },
    };
    ...
    var Mo = /[!'()*]/g,
      ...
      Bo = /%2C/g,
      No = function (t) {
        return encodeURIComponent(t).replace(Mo, Uo).replace(Bo, ",");
      },
    ...
    function li(t, e) {
      for (
        ...
        var l = n[0],
          c = n[1],
          u = n.index;
        if (((a += t.slice(i, u)), (i = u + l.length), c)) a += c[1];
        else {
          var f = t[i],
            p = n[2],
            d = n[3],
    ...
    function ui(t) {
      ...
      return function (n, r) {
        for (
          var o = "",
            i = n || {},
            a = (r || {}).pretty ? ci : encodeURIComponent,
            s = 0;
          s < t.length;
          s++
        ) {
    ...
    function bi(t, e, n, r) {
      ...
      var l = (function (t) {
        ...
        c = (e && e.path) || "/",
        u = l.path ? Jo(l.path, c, n || o.append) : c,
        f = (function (t, e, n) {
          void 0 === e && (e = {});
          var r,
            o = n || Qo;
    ...
    var _i,
      ...
      xi = {
        ...
        render: function (t) {
          ...
          var m = function (t) {
              Ci(t) && (e.replace ? n.replace(i, wi) : n.push(i, wi));
            },
            g = { click: Ci };
          ...
          if ("a" === this.tag) (y.on = g), (y.attrs = { href: s });
            ...
            if (_) {
              ...
              for (var x in ((w.on = w.on || {}), w.on)) {
                var C = w.on[x];
                x in g && (w.on[x] = Array.isArray(C) ? C : [C]);
              }
    ...
    function Oi(t, e) {
      ...
      function a(t, n, a) {
        ...
        if (c) {
          ...
          return (s.path = yi(u.path, s.params)), l(u, s, a);
        }
        if (s.path) {
          s.params = {};
          for (var d = 0; d < r.length; d++) {
            var h = r[d],
              v = o[h];
            if (Ti(v.regex, s.path, s.params)) return l(v, s, a);
          }
        }
        return l(null, s);
      }
      function s(t, n) {
        ...
        if (u) {
          var h = (function (t, e) {
            return Jo(t, e.parent ? e.parent.path : "/", !0);
          })(u, t);
          return a(
          ...
          if ("function" == typeof t && void 0 === t.cid) {
            ...
            var l,
              c = Zi(function (e) {
                var o;
                ((o = e).__esModule ||
                  (Yi && "Module" === o[Symbol.toStringTag])) &&
                  (e = e.default),
            ...
            if (l)
              if ("function" == typeof l.then) l.then(c, u);
                ...
                var f = l.component;
                f && "function" == typeof f.then && f.then(c, u);
              }
          }
        }),
          o || r();
    ...
    (ta.prototype.listen = function (t) {
      ...
      (ta.prototype.confirmTransition = function (t, e, n) {
        ...
        if (Yo(t, o) && t.matched.length === o.matched.length)
          return this.ensureURL(), i(new Ji(t));
        var a = (function (t, e) {
            var n,
      ...
      return (
        ...
        (e.prototype.push = function (t, e, n) {
          ...
          this.transitionTo(
            t,
            function (t) {
              Hi(ti(r.base + t.fullPath)), Ri(r.router, t, o, !1), e && e(t);
            },
            n
          );
        }),
      ...
      return (
        ...
        (e.prototype.setupListeners = function () {
          ...
          n && Ii(),
            window.addEventListener(
              Vi ? "popstate" : "hashchange",
              function () {
                var e = t.current;
                aa() &&
                  t.transitionTo(sa(), function (r) {
                    n && Ri(t.router, r, e, !0), Vi || ua(r.fullPath);
                  });
              }
            );
        }),
        (e.prototype.push = function (t, e, n) {
          ...
          this.transitionTo(
            t,
            function (t) {
              ca(t.fullPath), Ri(r.router, t, o, !1), e && e(t);
            },
            n
          );
        }),
    ...
    function ca(t) {
      Vi ? Hi(la(t)) : (window.location.hash = t);
    }
    function ua(t) {
    ...
    (pa.prototype.match = function (t, e, n) {
      ...
      (pa.version = "3.1.6"),
      $i && window.Vue && window.Vue.use(pa);
    var va = pa;
    var ma = {
        NotFound: () => n.e(8).then(n.bind(null, 173)),
        Layout: () =>
          Promise.all([n.e(0), n.e(3), n.e(4)]).then(n.bind(null, 172)),
      },
      ga = {
        "v-02afa083": () => n.e(5).then(n.bind(null, 174)),
        "v-5682e796": () => n.e(7).then(n.bind(null, 175)),
        "v-7ad61dca": () => n.e(9).then(n.bind(null, 176)),
        "v-1c0e8e90": () => n.e(11).then(n.bind(null, 177)),
        "v-a5beb172": () => n.e(10).then(n.bind(null, 178)),
        "v-4cbfcb05": () => n.e(13).then(n.bind(null, 179)),
        "v-4b142a3a": () => n.e(12).then(n.bind(null, 180)),
        "v-e51e2d82": () => n.e(2).then(n.bind(null, 181)),
        "v-74669ad6": () => n.e(14).then(n.bind(null, 182)),
        "v-37c93716": () => n.e(15).then(n.bind(null, 183)),
        "v-54b99194": () => n.e(16).then(n.bind(null, 184)),
        "v-cdf45914": () => n.e(17).then(n.bind(null, 185)),
        "v-075b2109": () => n.e(18).then(n.bind(null, 186)),
      };
    function ya(t) {
    ...
    const ba = /-(\w)/g,
      ...
      Ca = ya((t) => t.charAt(0).toUpperCase() + t.slice(1));
    function $a(t, e) {
      if (!e) return;
      if (t(e)) return t(e);
      return e.includes("-") ? t(Ca(_a(e))) : t(Ca(e)) || t(xa(e));
    }
    const qa = Object.assign({}, ma, ga),
      ka = (t) => qa[t],
      Oa = (t) => ga[t],
      Ta = (t) => ma[t],
      Sa = (t) => Po.component(t);
              ...
              if (s && l !== decodeURIComponent(i.hash)) {
                ...
                if (o === r)
                  for (let n = t + 1; n < e.length; n++)
                    if (l === decodeURIComponent(e[n].hash)) return;
                return (
        ...
        pages: [
          ...
          },
          {
            ...
            regularPath:
              "/Qiqqa.Internals.-.Configuration.Overrides.for.Developers.and.Testers.html",
            relativePath:
              "Qiqqa.Internals.-.Configuration.Overrides.for.Developers.and.Testers.md",
            key: "v-7ad61dca",
            path:
              "/Qiqqa.Internals.-.Configuration.Overrides.for.Developers.and.Testers.html",
            headers: [
              ...
              {
                level: 2,
                title: "Overriding the Qiqqa library Base Path",
                slug: "overriding-the-qiqqa-library-base-path",
              },
              {
                level: 3,
                title: "Why would you want to override this registry setting?",
                slug: "why-would-you-want-to-override-this-registry-setting",
              },
              {
                level: 3,
                title: "Commandline format",
                slug: "commandline-format",
              },
              {
                level: 2,
                title: "Overriding Qiqqa behaviour",
                slug: "overriding-qiqqa-behaviour",
              },
              {
                level: 3,
                title: "Configuring Qiqqa.Developer.Settings.json5",
                slug: "configuring-qiqqa-developer-settings-json5",
              },
              {
                level: 4,
                title: "LoadKnownWebLibraries",
                slug: "loadknownweblibraries",
              },
              {
                level: 4,
                title: "AddLegacyWebLibrariesThatCanBeFoundOnDisk",
                slug: "addlegacyweblibrariesthatcanbefoundondisk",
              },
              {
                level: 4,
                title: "SaveKnownWebLibraries",
                slug: "saveknownweblibraries",
              },
              {
                level: 4,
                title: "DoInterestingAnalysis_GoogleScholar",
                slug: "dointerestinganalysis-googlescholar",
              },
            ],
            lastUpdated: "4/3/2020, 10:09:57 PM",
          },
          {
            title: "Qiqqa",
            frontmatter: {},
          ...
          {
            frontmatter: {},
            regularPath: "/Software.Releases.-.Where.To.Get.Them.html",
    ...
    n(8);
    Po.component("Badge", () =>
      Promise.all([n.e(0), n.e(6)]).then(n.bind(null, 187))
    );
    new Po();
    n(9);
    var Za = {
    ...
    const ts = /#.*$/,
      ...
      rs = /^[a-z]+:/i;
    function os(t) {
      return decodeURI(t).replace(ts, "").replace(es, "");
    }
    function is(t) {
      return rs.test(t);
    }
    function as(t) {
      ...
      const e = t.match(ts),
        n = e ? e[0] : "",
        r = os(t);
      return ns.test(r) ? t : r + ".html" + n;
    }
    function ss(t, e, n) {
      if (is(e)) return { type: "external", path: e };
      n &&
        (e = (function (t, e, n) {
          const r = t.charAt(0);
          if ("/" === r) return t;
      ...
      for (let e = 0; e < t.length; e++)
        if (os(t[e].regularPath) === r)
          return Object.assign({}, t[e], { type: "page", path: as(t[e].path) });
      return (
        console.error(
        ...
        return n
          ? n.map((e) =>
              (function t(e, n, r, o = 1) {
                if ("string" == typeof e) return ss(n, e, r);
                if (Array.isArray(e))
                  return Object.assign(ss(n, e[0], r), { title: e[1] });
                {
                  const i = e.children || [];
                  return 0 === i.length && e.path
                    ? Object.assign(ss(n, e.path, r), { title: e.title })
                    : {
                        type: "group",
                        path: e.path,
                        title: e.title,
    ...
    var ps = [
        ...
        {},
        async ({ router: t, isServer: e }) => {
          0;
        },
        {},
        ({ Vue: t }) => {
          t.component("BackToTop", Ja);
        },
        ({ Vue: t }) => {
          t.component("GlobalTableOfContents", us);
        },
        ({ Vue: t }) =>
          t.component("TOC", () => n.e(21).then(n.bind(null, 171))),
        ({ Vue: t, router: e }) => {
          e.options.scrollBehavior = (e, n, r) => {
            if (r) return window.scrollTo({ top: r.y, behavior: "smooth" });
            if (!e.hash) return window.scrollTo({ top: 0, behavior: "smooth" });
            {
              if (t.$vuepress.$get("disableScrollBehavior")) return;
              const n = document.querySelector(e.hash);
              if (n)
                return window.scrollTo({ top: fs(n).y, behavior: "smooth" });
            }
          };
        },
      ],
    ...
    var gs = {
        ...
        render(t) {
          ...
          return (
            Ia("pageKey", e),
            Po.component(e) || Po.component(e, Aa(e)),
    ...
    (Po.config.productionTip = !1),
      ...
      Po.component("Content", gs),
      Po.component("ContentSlotsDistributor", ys),
      Po.component("OutboundLink", bs),
      Po.component("ClientOnly", _s),
      ...
      (window.__VUEPRESS__ = { version: "1.4.0", hash: "3a642b56" }),
      (async function (t) {
        const e =
        ...
        try {
          await Promise.all(
            ps
              ...
              .map((e) =>
                e({ Vue: Po, options: r, router: n, siteData: Ya, isServer: t })
              )
          );
        } catch (t) {
          console.error(t);
