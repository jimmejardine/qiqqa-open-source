...
ISCC is the Inno Setup compiler which is kicked off by ant, this is instead of the Inno Setup IDE, which can also be used.
...
Had a look at Windows version numbers, and tried to match them up the the .NET dependencies.  Not too simple, so wen't with the assumption above.
