...
namespace QiqqaLegacyFileFormats          // namespace Utilities.Misc
{
    [Serializable]
    public class DictionaryBasedObject 
    {
        ...
        public DateTime? GetDateTime(string key)
        {
            ...
            if (null != datetime && datetime.HasValue && datetime.Value != Constants.DATETIME_MIN)
            {
