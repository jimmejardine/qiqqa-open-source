...
Maybe we can. Please also read [the section further above about commercial Qiqqa Web Accounts](https://github.com/jimmejardine/qiqqa-open-source/tree/master#--i-had-a-commercial-qiqqa-user-account-and-web-libraries-aka-cloud-storage-can-it-be-accessed--recovered); it may be relevant to you. 
